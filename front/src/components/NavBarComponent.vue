          ...
          <ul class="navbar-nav me-auto mb-2 mb-md-0">
            ...
            <li class="nav-item dropdown" :style="{ cursor: hasAdminRole ? 'inherit' : 'not-allowed' }">
              ...
              <ul class="dropdown-menu">
                <li class="li-plus-option">
                  <RouterLink class="dropdown-item" to="/administracao/problemas/categorias" role="button">
                ...
                <li>
                  <RouterLink class="dropdown-item" to="/administracao/problemas/TextosProntos">
                    <i class="bi bi-text-left"></i>
                    Problemas (Textos Prontos)
                  </RouterLink>
                </li>
              </ul>
            </li>
            <li class="nav-item dropdown" :style="{ cursor: hasAdminRole ? 'inherit' : 'not-allowed' }" >
              ...
              <ul class="dropdown-menu">
                <li class="li-plus-option">
                  <RouterLink class="dropdown-item" to="/administracao/emailsTemplates/cadastro">
                ...
                <li class="li-plus-option">
                  <RouterLink class="dropdown-item" to="/administracao/emailsTemplates/listagem">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-list-ul" viewBox="0 0 16 16">
                      <path fill-rule="evenodd" d="M5 11.5a.5.5 0 0 1 .5-.5h9a.5.5 0 0 1 0 1h-9a.5.5 0 0 1-.5-.5m0-4a.5.5 0 0 1 .5-.5h9a.5.5 0 0 1 0 1h-9a.5.5 0 0 1-.5-.5m0-4a.5.5 0 0 1 .5-.5h9a.5.5 0 0 1 0 1h-9a.5.5 0 0 1-.5-.5m-3 1a1 1 0 1 0 0-2 1 1 0 0 0 0 2m0 4a1 1 0 1 0 0-2 1 1 0 0 0 0 2m0 4a1 1 0 1 0 0-2 1 1 0 0 0 0 2"/>
                    </svg>
                    Listagem
            ...
            <li class="nav-item dropdown" :style="{ cursor: hasAdminRole ? 'inherit' : 'not-allowed' }" >
              ...
              <ul class="dropdown-menu">
                <li class="li-plus-option">
                  <RouterLink class="dropdown-item" to="/administracao/fornecedores/cadastro">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-plus-circle" viewBox="0 0 16 16">
                      <path d="M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14m0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16"/>
                      <path d="M8 4a.5.5 0 0 1 .5.5v3h3a.5.5 0 0 1 0 1h-3v3a.5.5 0 0 1-1 0v-3h-3a.5.5 0 0 1 0-1h3v-3A.5.5 0 0 1 8 4"/>
                    </svg>
                ...
                <li>
                  <RouterLink class="dropdown-item" to="/administracao/fornecedores/listagem">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-list-ul" viewBox="0 0 16 16">
                      <path fill-rule="evenodd" d="M5 11.5a.5.5 0 0 1 .5-.5h9a.5.5 0 0 1 0 1h-9a.5.5 0 0 1-.5-.5m0-4a.5.5 0 0 1 .5-.5h9a.5.5 0 0 1 0 1h-9a.5.5 0 0 1-.5-.5m0-4a.5.5 0 0 1 .5-.5h9a.5.5 0 0 1 0 1h-9a.5.5 0 0 1-.5-.5m-3 1a1 1 0 1 0 0-2 1 1 0 0 0 0 2m0 4a1 1 0 1 0 0-2 1 1 0 0 0 0 2m0 4a1 1 0 1 0 0-2 1 1 0 0 0 0 2"/>
                    </svg>
                    Listagem
            ...
            <li id="clientes" class="nav-item dropdown" :style="{ cursor: hasAdminRole ? 'inherit' : 'not-allowed' }" >
              ...
              <ul class="dropdown-menu">
                <li class="li-plus-option" >
                  <RouterLink class="dropdown-item" to="/administracao/clientes/cadastro">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-plus-circle" viewBox="0 0 16 16">
                      <path d="M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14m0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16"/>
                      <path d="M8 4a.5.5 0 0 1 .5.5v3h3a.5.5 0 0 1 0 1h-3v3a.5.5 0 0 1-1 0v-3h-3a.5.5 0 0 1 0-1h3v-3A.5.5 0 0 1 8 4"/>
                    </svg>
                ...
                <li>
                  <RouterLink class="dropdown-item" to="/administracao/clientes/listagem">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-list-ul" viewBox="0 0 16 16">
                      <path fill-rule="evenodd" d="M5 11.5a.5.5 0 0 1 .5-.5h9a.5.5 0 0 1 0 1h-9a.5.5 0 0 1-.5-.5m0-4a.5.5 0 0 1 .5-.5h9a.5.5 0 0 1 0 1h-9a.5.5 0 0 1-.5-.5m0-4a.5.5 0 0 1 .5-.5h9a.5.5 0 0 1 0 1h-9a.5.5 0 0 1-.5-.5m-3 1a1 1 0 1 0 0-2 1 1 0 0 0 0 2m0 4a1 1 0 1 0 0-2 1 1 0 0 0 0 2m0 4a1 1 0 1 0 0-2 1 1 0 0 0 0 2"/>
                    </svg>
                    Listagem
            ...
            <li class="nav-item">
                <RouterLink class="nav-link" to="/aboutUs">
            ...
            <!-- <li class="nav-item">
              <RouterLink class="nav-link" aria-current="page" to="/administracao/relatorios">
