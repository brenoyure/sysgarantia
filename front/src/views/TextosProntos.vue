...
<div style="display: grid;">
    ...
    <form style="display: grid;" @submit.prevent="cadastrarNovaDescricaoProblema">
        ...
        <div>
            ...
            <input id="novoProblema-descricaoResumida" class="form-control" v-model="descricaoProblema.descricaoResumida" required placeholder="ex. Mouse - Problema no Scroll" >
        </div>
        <div>
            <label for="novoProblema-descricaoDetalhada" style="font-weight: bold">Descrição Detalhada: </label>
            <textarea rows="5" id="novoProblema-descricaoDetalhada" class="form-control" v-model="descricaoProblema.descricaoDetalhada" required placeholder="ex. Equipamento está apresentando defeito de ..." ></textarea>
        </div>
